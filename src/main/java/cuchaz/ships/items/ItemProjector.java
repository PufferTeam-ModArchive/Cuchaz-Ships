...
public class ItemProjector extends ItemBlock {
    ...
    public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer player) {
        ...
        try {
            ...
            Ships.net.getDispatch()
                .sendToServer(new PacketPlaceProjector(encodedBlocks, x, y + 1, z));
    ...
    @Override
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int sideId,
