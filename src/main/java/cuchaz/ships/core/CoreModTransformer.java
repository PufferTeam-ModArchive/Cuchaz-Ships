...
public class CoreModTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] classData) {
        ...
        try {
            ...
            List<String> privilegedPackages = Arrays.asList(
                "cuchaz.ships.",
                "cuchaz.modsShared",
                "net.minecraftforge.",
                "cpw.",
            ...
            if (m_adapterHead == null || m_adapterTail == null) {
                ObfuscationAwareAdapter adapter = new TileEntityInventoryAdapter(
                    Opcodes.ASM4,
                    null,
                    CoreModPlugin.isObfuscatedEnvironment);
                ...
                adapter = new ServerConfigurationManagerAdapter(
                    Opcodes.ASM4,
                    adapter,
                    CoreModPlugin.isObfuscatedEnvironment);
            ...
            System.out.println(
                "Exception occurred while transforming class " + name
                    + ":"
                    + transformedName
                    + ". This class has been skipped and left un-transformed.");
